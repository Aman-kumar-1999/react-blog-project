...
export default function CBEXIV() {
  ...
  const createProductsInBulk = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/excel/cbexiv`, formData, {
        headers: {
  ...
  return (
    <>
      ...
      <label className="label" aria-hidden="true">Select Your CBE-XIV Excel</label>
